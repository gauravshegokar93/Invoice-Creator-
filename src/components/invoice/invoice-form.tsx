      ...
      <Accordion type="multiple" defaultValue={['payment-terms']} className="w-full">
        <AccordionItem value="payment-terms">
          ...
          <AccordionContent>
             <Card>
              <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField control={form.control} name="paymentTerms.termsText" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Payment Terms</FormLabel><FormControl><Textarea placeholder="e.g., 50% advance..." {...field} /></FormControl><FormMessage /></FormMessage></FormItem>)} />
